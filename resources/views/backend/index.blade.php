...
@section('title', 'Prolific || DASHBOARD')
@section('main-content')
    <div class="container-fluid">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    Rp{{ number_format($salesThisMonth, 0, ',', '.') }}</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    Rp{{ number_format($salesToday, 0, ',', '.') }}</div>
                            </div>
                            <div class="col-auto">
        ...
        <div class="row">
            ...
            {{-- Letakkan kode ini di dalam <div class="row"> yang kosong --}}

            <div class="col-lg-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">
                            <i class="fas fa-history"></i> 5 Pesanan Terbaru
                        </h6>
                    </div>
                    <div class="card-body">
                                        ...
                                        @foreach ($recent_orders as $order)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if ($order->status == 'new')
                                                        <span
                                                            class="badge badge-primary">{{ ucfirst($order->status) }}</span>
                                                    @elseif($order->status == 'process')
                                                        <span
                                                            class="badge badge-warning">{{ ucfirst($order->status) }}</span>
                                                    @elseif($order->status == 'delivered')
                                                        <span
                                                            class="badge badge-success">{{ ucfirst($order->status) }}</span>
                                                    @else
                                                        <span
                                                            class="badge badge-danger">{{ ucfirst($order->status) }}</span>
                                                    @endif
                                                </td>
                    ...
                    <div class="card-footer text-center">
                        <a href="{{ route('order.index') }}" class="text-primary font-weight-bold">
            ...
            axios.get(url)
                .then(function(response) {
                    ...
                    var myLineChart = new Chart(ctx, {
                        type: 'line',
                        data: {
                            labels: ["Januari", "Februari", "Maret", "April", "May", "Juni", "Juli", "Agustus",
