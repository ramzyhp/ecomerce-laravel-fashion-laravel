        ...
        <div class="card-body">
            <form method="post" action="{{ route('coupon.update', $coupon->id) }}">
                ...
                <div class="form-group">
                    ...
                    <input id="inputTitle" type="text" name="code" placeholder="Masukkan Kode Kupon"
                ...
                <div class="form-group">
                    ...
                    <select name="type" class="form-control">
                        <option value="fixed" {{ $coupon->type == 'fixed' ? 'selected' : '' }}>Nilai Tetap</option>
                ...
                <div class="form-group">
                    ...
                    <input id="inputTitle" type="number" name="value" placeholder="Masukkan Nilai Kupon"
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="inactive" {{ $coupon->status == 'inactive' ? 'selected' : '' }}>Tidak Aktif
                        </option>
                    </select>
                    @error('status')
                        <span class="text-danger">{{ $message }}</span>
