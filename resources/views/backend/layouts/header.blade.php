<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    {{-- <a href="{{route('storage.link')}}" class="btn btn-outline-warning btn-sm mr-3 d-none d-sm-block">
        Storage Link
    </a>
    <a href="{{route('cache.clear')}}" class="btn btn-outline-danger btn-sm mr-3 d-none d-sm-block">
        Hapus Cache
    </a> --}}
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="{{ route('change.password.forms') }}">
                ...
                <a class="dropdown-item" href="{{ route('admin.logout') }}"
                    ...
                    <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i> {{ __('Keluar') }}
                </a>
